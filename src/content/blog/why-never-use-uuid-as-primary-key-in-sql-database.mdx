---
title: 'How Random UUIDs Damage B-tree Performance in Databases'
description: "UUID v4's random nature wreaks havoc on B-tree indexes in SQL databases, causing excessive page splits, fragmentation, and poor cache utilization. Learn the mechanics of why this happens and how sequential IDs solve these problems."
pubDate: 'Mar 17 2025'
tags: 'os, database'
group: 'systems'
